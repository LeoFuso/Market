...
public class ShoppingCartController {
    ...
    @PutMapping(value = "/{id}/order", produces = "application/json")
    public Mono<CartResource> putAnOrder(@PathVariable Long id) {
    ...
    public Mono<CartResource> removeItem(@PathVariable Long id,
                                      @Valid @RequestBody final Mono<RemoveCartItemRequest> request) {
